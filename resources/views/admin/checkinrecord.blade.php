...
>
  ...
  <h2 class="card-title fw-bold text-primary"></h2>
                                ...
                                <!-- Employee Table -->
                                <form action="{{ route('getCheckInData.fetch') }}" method="POST" id="employee-form"
                                    ...
                                    <table class="table table-hover table-bordered align-middle text-left ">
                                            ...
                                            <tr>
                                              ...
                                              <th scope="col" class="text-left text-nowrap">Date</th>
                                                ...
                                                <th scope="col" class="text-center text-nowrap">Check In</th>
                                                <th scope="col" class="text-center text-nowrap">Check Out</th>
                                        ...
                                        <tbody>
                                            @foreach ($query as $task)
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">{{ $task->check_out_time ?? "-- : --" }}</td>
