        ...
        <nav class="sidebar-nav scroll-sidebar " data-simplebar="">
            <ul id="sidebarnav">
               ...
               <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/screenActivity" aria-expanded="false">
                        <span>
                            <iconify-icon icon="mdi:monitor-eye" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu">Screen Activity</span>
                    </a>
                </li>
              <li class="sidebar-item">
                    <a class="sidebar-link" href="/userActivity" aria-expanded="false">
                        <span>
                            <iconify-icon icon="mdi:camera-image" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu">User Activity</span>
                    </a>
                </li>
               <li class="sidebar-item">
                    <a class="sidebar-link" href="/client-list" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item {{ request()->is('addproject') || request()->is('projectlist') ? 'active' : '' }}">
                    ...
                    <ul class="collapse first-level {{ request()->is('addproject') || request()->is('projectlist') ? 'in' : '' }}" style="margin-left: 45px;">
                       <li class="sidebar-item">
                            <a class="sidebar-links sidebar-link {{ request()->is('projectlist') ? 'd-flex align-items-center active' : '' }}" href="/projectlist">
                        ...
                        <li class="sidebar-item sidebar-items">
                            <a class="sidebar-links sidebar-link {{ request()->is('addproject') ? 'd-flex align-items-center active' : '' }}" href="/addproject">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/addemployee" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item {{ request()->is('employee*') ? 'active' : '' }}">
                    ...
                    <ul class="collapse first-level {{ request()->is('employee*') ? 'in' : '' }}" style="margin-left: 45px;">
                        <li class="sidebar-item" style="margin-bottom: 0px;">
                            <a class="sidebar-link sidebar-links" href="/employee">
                        ...
                        <li class="sidebar-item {{ request()->is('addemployee') ? 'active' : '' }}">
                            <a class="sidebar-link sidebar-links" href="/addemployee">
                ...
                {{-- <li class="sidebar-item">
                    <a class="sidebar-link" href="/addproject" aria-expanded="false">
                        <span>
                ...
                {{-- <li class="sidebar-item">
                    <a class="sidebar-link" href="/getCheckInData" aria-expanded="false">
                        <span>
                            <iconify-icon icon="solar:file-text-bold-duotone" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu">Check In Record</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/taskreport" aria-expanded="false">
                        <span>
                            <iconify-icon icon="solar:text-field-focus-bold-duotone" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu">Daily Task Report</span>
                    </a>
                </li> --}}
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/leaveRequests" aria-expanded="false">
                        <span>
               ...
               <li class="sidebar-item">
                    <a class="sidebar-link" href="/documents" aria-expanded="false">
                        <span>
              ...
              <li class="sidebar-item">
                    <a class="sidebar-link" href="/getsalaryusers" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item {{ request()->is('getCheckInData') || request()->is('taskreport') ? 'selected' : '' }}">
                    ...
                    <ul class="collapse first-level {{ request()->is('getCheckInData') || request()->is('taskreport') ? 'show' : '' }}" style="margin-left: 45px;">
                        <li class="sidebar-item" style="margin-bottom: 0px">
                            <a class="sidebar-link sidebar-links {{ request()->is('getCheckInData') ? 'active' : '' }}" href="/getCheckInData">
                                {{-- <span class="hide-menu">Check In/Check Out Report</span> --}}
                                <span class="submenu-dot">•</span> <span class="hide-menu">Check In/out</span>
                            </a>
                        </li>
                        <li class="sidebar-item" style="margin-bottom: 0px">
                            <a class="sidebar-link sidebar-links {{ request()->is('taskreport') ? 'active' : '' }}" href="/taskreport">
                                {{-- <span class="hide-menu">Daily Task Report</span> --}}
                                <span class="submenu-dot">•</span> <span class="hide-menu">Daily Task</span>
                            </a>
                        </li>
                        <li class="sidebar-item" style="margin-bottom: 0px">
               ...
               <li class="sidebar-item">
                    <a class="sidebar-link" href="/asktoai" aria-expanded="false">
                        <span>
                            <iconify-icon icon="mdi:robot-outline" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu">Ask To AI</span>
                    </a>
                </li>
