                                    ...
                                    <form action="{{ route('update-client', $client->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" id="company_website_url"
                                                    name="company_website_url"
                                                    value="{{ $client->company_website_url }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="email" class="form-control" id="official_email"
                                                    name="official_email" value="{{ $client->official_email }}"
                                                    placeholder="Enter clients's official email" required>
                                            </div>
                                            <!-- Date of Joining -->
                                            <div class="col-md-6 mb-4">
                                                <label for="date_of_joining" class="form-label">Official Contact
                                                    Number</label>
                                                <input type="number" id="official_contact_name" class="form-control"
                                                    value="{{ $client->official_contact_name }}"
                                                    placeholder="Enter official contact number"
                                                    name="official_contact_name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" id="full_name" class="form-control"
                                                    name="full_name" value="{{ $client->full_name }}"
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="email" class="form-control" id="personal_email"
                                                    name="personal_email" value="{{ $client->personal_email }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" id="personal_contact_name" class="form-control"
                                                    value="{{ $client->personal_contact_name }}"
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" id="city" class="form-control"
                                                    value="{{ $client->city }}" placeholder="Enter city" name="city"
                                                    required>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="full_address" id="full_address" class="form-control" cols="30" rows="5"
                                                placeholder="Enter client's full address" required>{{ $client->full_address }}</textarea>
                                        </div>
