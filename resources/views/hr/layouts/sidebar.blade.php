        ...
        <nav class="sidebar-nav scroll-sidebar " data-simplebar="">
            <ul id="sidebarnav">
               ...
               {{-- <li class="sidebar-item">
                ...
                <li class="sidebar-item {{ request()->is('employee*') ? 'active' : '' }}">
                    ...
                    <ul class="collapse first-level {{ request()->is('employee*') ? 'in' : '' }}" style="margin-left: 45px;">
                        <li class="sidebar-item" style="margin-bottom: 0px;">
                            <a class="sidebar-link sidebar-links" href="hr-employees">
                        ...
                        <li class="sidebar-item {{ request()->is('addemployee') ? 'active' : '' }}">
                            <a class="sidebar-link sidebar-links" href="/hr-addemployee">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/hr-leaveRequests" aria-expanded="false">
                        <span>
               ...
               <li class="sidebar-item">
                    <a class="sidebar-link" href="/hr-documents" aria-expanded="false">
                        <span>
              ...
              <li class="sidebar-item">
                    <a class="sidebar-link" href="/hr-getsalaryusers" aria-expanded="false">
                        <span>
